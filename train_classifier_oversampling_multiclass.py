...
syn_dataset_film_1_group3 = load_dataset("imagefolder", data_dir='/home/marta/workshop/77_original')
syn_dataset_film_2_group3 = load_dataset("imagefolder", data_dir='/home/marta/workshop/13_original')
syn_dataset_digital_1_group3 = load_dataset("imagefolder", data_dir='/home/marta/workshop/2789_original')
syn_dataset_digital_2_group3 = load_dataset("imagefolder", data_dir='/home/marta/workshop/3941_original')

# '''READING SYNTHETIC DATA FOR GROUP OF ZOOM 1'''
syn_dataset_film_1_group1 = load_dataset("imagefolder", data_dir='/home/marta/workshop/75_original')
syn_dataset_film_2_group1 = load_dataset("imagefolder", data_dir='/home/marta/workshop/11_original')
syn_dataset_digital_1_group1 = load_dataset("imagefolder", data_dir='/home/marta/workshop/2787_original')
syn_dataset_digital_2_group1 = load_dataset("imagefolder", data_dir='/home/marta/workshop/3939_original')
...
features_3939= metadata_df[metadata_df['file_name']=='3939.png']
features_2787=metadata_df[metadata_df['file_name']=='2787.png']
features_75=metadata_df[metadata_df['file_name']=='75.png']
features_11=metadata_df[metadata_df['file_name']=='11.png']
...
all_indices = list(range(len(data['train'])))
print('\n len(data[train])', len(data['train']))
train_val_indices = list(set(all_indices) - set(test_indices))

train_val_indices = np.array(train_val_indices, dtype=np.int64)
...
# print('\n cv_train_precisions: ', cv_train_precisions)
